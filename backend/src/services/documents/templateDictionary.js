...
const TOKEN_SECTIONS = {
  common: [
    ...
    { token: 'enterprise_inn', description: 'ИНН предприятия', section: 'common' },
    { token: 'enterprise_kpp', description: 'КПП предприятия, если применяется', section: 'common' },
    { token: 'enterprise_ogrn', description: 'ОГРН или ОГРНИП предприятия', section: 'common' },
    { token: 'enterprise_address', description: 'Юридический адрес предприятия', section: 'common' },
    { token: 'enterprise_phone', description: 'Контактный телефон предприятия', section: 'common' },
    { token: 'manager_position', description: 'Должность руководителя предприятия', section: 'common' },
    { token: 'manager_name', description: 'ФИО руководителя предприятия', section: 'common' },
    { token: 'agronomist_position', description: 'Должность ответственного агронома', section: 'common' },
    { token: 'agronomist_name', description: 'ФИО ответственного агронома', section: 'common' },
  ],
  singleOnly: [
